        ...
        for j in range(BOARD_SIZE):
            ...
            if index != str(EMPTY_SQUARE):
                ...
                c.create_rectangle(j*SQUARE_SIZE, i*SQUARE_SIZE,
                                    ...
                                    fill='#43ABC9', outline='#FFFFFF')
                # пишем число в центре квадрата
                c.create_text(j*SQUARE_SIZE+SQUARE_SIZE/2, i*SQUARE_SIZE+SQUARE_SIZE/2,
                                text=index, font='Arial {} italic'.format(int(SQUARE_SIZE/4)), 
                                fill='#FFFFFF')
...
# В качестве пятнашек у нас будет список c целыми числами
